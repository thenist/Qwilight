...
function Pipeline()
	if IsClassic() then
		return "1, 26, 3, 4, 7, 8, 57, 31, 102, 103, 100, 101, 2, 6, 9, 10, 11, 12, 13, 14, 30, 28, 15, 16, 27, 29, 33, 35, 36, 37, 38, 39, 40, 43, 44, 46, 47, 48, 51, 58, 104"
	else
		return "1, 26, 3, 4, 7, 8, 57, 31, 102, 103, 100, 101, 61, 2, 6, 9, 10, 11, 12, 13, 14, 30, 28, 15, 16, 27, 29, 33, 35, 36, 37, 38, 39, 40, 43, 44, 46, 47, 48, 51, 58, 104"
	end
end
