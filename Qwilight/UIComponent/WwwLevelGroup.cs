...
{
    public sealed partial class WwwLevelGroup : Model
    {
        ...
        public override bool Equals(object obj) => obj is WwwLevelGroup wwwLevelGroup && LevelName == wwwLevelGroup.LevelName;

        public override int GetHashCode() => LevelName.GetHashCode();
    }
}
