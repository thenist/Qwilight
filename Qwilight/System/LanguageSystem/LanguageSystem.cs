...
namespace Qwilight
{
    public sealed partial class LanguageSystem : Model
    {
        ...
        public void Init(string language)
        {
            ...
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm4] = InputFavorModeFill4;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm5] = InputFavorModeFill5;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm6] = InputFavorModeFill6;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm7] = InputFavorModeFill7;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm8] = InputFavorModeFill8;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm9] = InputFavorModeFill9;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm10] = InputFavorModeFill10;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm5_1] = InputFavorModeFill51;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm7_1] = InputFavorModeFill71;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm10_2] = InputFavorModeFill102;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm14_2] = InputFavorModeFill142;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm24_2] = InputFavorModeFill242;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Algorithm48_4] = InputFavorModeFill484;
