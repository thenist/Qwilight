...
namespace Qwilight
{
    public sealed partial class LanguageSystem : Model
    {
        ...
        public void Init(string language)
        {
            ...
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled4] = InputFavorModeLabelled4;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled5] = InputFavorModeLabelled5;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled6] = InputFavorModeLabelled6;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled7] = InputFavorModeLabelled7;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled8] = InputFavorModeLabelled8;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled9] = InputFavorModeLabelled9;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled10] = InputFavorModeLabelled10;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled5_1] = InputFavorModeLabelled51;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled7_1] = InputFavorModeLabelled71;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled10_2] = InputFavorModeLabelled102;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled14_2] = InputFavorModeLabelled142;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled24_2] = InputFavorModeLabelled242;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Labelled48_4] = InputFavorModeLabelled484;
