...
namespace Qwilight
{
    public sealed partial class LanguageSystem : Model
    {
        ...
        public void Init(string language)
        {
            ...
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill4] = InputFavorModeFill4;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill5] = InputFavorModeFill5;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill6] = InputFavorModeFill6;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill7] = InputFavorModeFill7;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill8] = InputFavorModeFill8;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill9] = InputFavorModeFill9;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill10] = InputFavorModeFill10;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill5_1] = InputFavorModeFill51;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill7_1] = InputFavorModeFill71;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill10_2] = InputFavorModeFill102;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill14_2] = InputFavorModeFill142;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill24_2] = InputFavorModeFill242;
            InputFavorModeTexts[(int)ModeComponent.InputFavorMode.Fill48_4] = InputFavorModeFill484;
