...
Robocopy x64\Release Qwilight\Assets\AMD64 Flint.exe
"%MSBUILD%" -t:Build -p:Configuration=Release,Platform=ARM64 Flint\Flint.vcxproj
Robocopy ARM64\Release Qwilight\Assets\ARM64 Flint.exe
...
Robocopy x64\Release Qwilight\Assets\AMD64 NVIDIA.dll

"%MSBUILD%" -t:Build -p:Configuration=Release,Platform=x64 Xwindow\Xwindow.vcxproj
Robocopy x64\Release Qwilight\Assets\AMD64 Xwindow.exe
